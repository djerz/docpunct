-- Font settings
--vim.opt.guifont = "SauceCodePro NF:h10" -- Set the GUI font to "SauceCodePro NF"
--vim.opt.guifont = "Noto Mono:h12" -- Set the GUI font to "Noto Mono"
vim.opt.guifont = "FiraCode Nerd Font:h11" -- Set the GUI font to "FiraCode Nerd Font"
